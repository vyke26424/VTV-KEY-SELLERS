          ...
          >
            ...
            <div className="container mx-auto px-8 md:px-16 grid grid-cols-1 md:grid-cols-2 items-center relative z-10">
              ...
              <div className="space-y-6">
                ...
                >
                  <span
                    className={`px-3 py-1 rounded-full bg-white/10 backdrop-blur-md text-xs font-bold uppercase tracking-wider ${SLIDES[current].highlightColor}`}
                  >
                    <Star size={12} className="inline mr-1 mb-0.5" /> Sản phẩm
                    nổi bật
                  </span>
                </motion.div>
