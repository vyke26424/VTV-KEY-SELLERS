...
const SLIDES = [
  ...
  // 6. Envato
  {
    ...
    features: ['Download Unlimited', 'Giấy phép thương mại', 'Update hàng ngày']
  },
  // 7. CapCut
  {
    id: 7,
            ...
            <div className="container mx-auto px-6 md:px-16 grid grid-cols-1 md:grid-cols-2 items-center relative z-10 gap-8">
              ...
              <div className="space-y-6 text-center md:text-left">
                ...
                >
                  ...
                  <div className="text-center md:text-left">
                    <p className="text-gray-400 text-xs font-medium uppercase">Giá khuyến mãi</p>
              ...
              >
                ...
                <div className="relative z-10 w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
                    {/* 👇 ĐÃ SỬA: Thêm class `rounded-3xl` và `shadow-2xl` để bo tròn đẹp hơn */}
                    <img 
                    ...
                    >
                        ...
                        <div>
                            <p className="text-[10px] text-gray-300 font-bold uppercase">Bán chạy</p>
