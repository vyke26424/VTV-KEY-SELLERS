  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-vtv-card border border-yellow-500/50 p-6 rounded-2xl shadow-2xl max-w-sm w-full text-center relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 h-1 bg-yellow-500 transition-all duration-1000 ease-linear" 
        ...
        <h3 className="text-xl font-bold text-white mb-2">Cảnh báo hết phiên!</h3>
        <p className="text-gray-400 text-sm mb-6">
           Phiên đăng nhập của bạn sẽ kết thúc sau <strong className="text-yellow-500 text-lg">{countdown}</strong> giây nữa. 
