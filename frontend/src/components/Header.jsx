      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        >
          <div className="relative">
            ...
            {loading ? (
              <Loader
                className="absolute right-3 top-2.5 text-vtv-green animate-spin"
                size={16}
              />
            ) : (
              query && (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="text-sm font-bold text-white truncate group-hover:text-vtv-green transition-colors">
                            {prod.name}
                          </h4>
                          <div className="flex items-center gap-2 text-xs">
                            <span className="text-vtv-green font-mono">
                              {minPrice > 0
                                ? formatCurrency(minPrice)
                                : 'Liên hệ'}
                            </span>
                            <span className="text-gray-500">
                              • {prod.category?.name || 'Phần mềm'}
                            </span>
                          </div>
                        </div>
                      </Link>
        ...
        <div className="flex items-center gap-6 text-sm font-bold">
          <Link
            to="/cart"
            className="flex items-center gap-2 hover:text-vtv-green transition relative group"
          >
            <div className="relative">
          ...
          {isAuthenticated ? (
            ...
            <Link
              to="/login"
              className="flex items-center gap-2 hover:text-vtv-green transition border-l border-slate-700 pl-6"
            >
