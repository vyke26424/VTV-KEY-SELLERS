              ...
              <form onSubmit={handleProfileUpdate} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    value={profile.email}
                    disabled
                    className="w-full bg-slate-950 border border-slate-700 rounded-lg p-3 text-gray-500 cursor-not-allowed"
                  />
                </div>
                <div>
                  <label className="block text-sm text-gray-400 mb-1">
                ...
                <div className="pt-4 flex justify-end">
                  <button
                    disabled={loading}
                    className="bg-vtv-green text-black font-bold px-6 py-2.5 rounded-lg hover:bg-green-400 transition flex items-center gap-2 shadow-lg shadow-green-500/20 disabled:opacity-50"
                  >
                    <Save size={20} />{' '}
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-6">
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-1 flex items-center gap-2">
                  <CreditCard size={16} /> Thông tin ngân hàng (Hiển thị cho
                  khách)
                </label>
                <textarea
                  rows="3"
                ...
                <div className="flex items-center justify-between p-4 bg-slate-950 rounded-lg border border-slate-800">
                  <div>
                    ...
                    <div className="text-xs text-gray-500">
                      Tạm ngưng website để nâng cấp (Chỉ Admin truy cập được)
                    </div>
                  </div>
