        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-slate-900/80 border border-slate-700 p-6 rounded-xl h-fit">
            ...
            <ul className="space-y-6">
              <li className="flex items-center gap-4">
                <div className="bg-vtv-green/10 p-3 rounded-full text-vtv-green border border-vtv-green/20">
                  <Mail size={20} />
                </div>
                <div>
              ...
              <li className="flex items-center gap-4">
                <div className="bg-blue-500/10 p-3 rounded-full text-blue-500 border border-blue-500/20">
                  <Phone size={20} />
                </div>
                <div>
                  <p className="text-xs text-gray-500 font-bold uppercase mb-1">
              ...
              <li className="flex items-center gap-4">
                <div className="bg-purple-500/10 p-3 rounded-full text-purple-500 border border-purple-500/20">
                  <MapPin size={20} />
                </div>
                <div>
                  <p className="text-xs text-gray-500 font-bold uppercase mb-1">
          ...
          <form className="bg-slate-900/80 border border-slate-700 p-8 rounded-xl space-y-4 shadow-lg backdrop-blur-sm">
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-600 rounded-lg p-3 focus:border-vtv-green outline-none text-white"
            />
            <input
              type="email"
