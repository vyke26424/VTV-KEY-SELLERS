...
const PolicyPage = () => {
  ...
  const PolicySection = ({
    ...
    >
      <h3
        className={`text-lg font-bold mb-4 flex items-center gap-3 ${isWarning ? 'text-red-400' : 'text-white'}`}
      >
        <span
      ...
      <div
        className={`pl-11 leading-relaxed text-sm md:text-base space-y-2 ${isWarning ? 'text-gray-100' : 'text-gray-300'}`}
      >
        {children}
      </div>
    </div>
        ...
        <div className="grid gap-6">
          ...
          >
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <strong>Sản phẩm áp dụng:</strong> Tất cả các Key/Tài khoản được
                xuất ra từ hệ thống VTVKey.
              </li>
              <li>
                <strong>Thời hạn bảo hành:</strong> Tương ứng với tên và mô tả
                của gói dịch vụ khách đã mua (Ví dụ: Gói 1 năm bảo hành 1 năm).
              </li>
            </ul>
          </PolicySection>
          ...
          <PolicySection
            number="2"
            title="Điều kiện bảo hành (1 đổi 1)"
            icon={<RefreshCw />}
          >
            <p className="mb-2 font-medium text-white">
              Sản phẩm sẽ được đổi mới ngay lập tức nếu:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                Key/Tài khoản không thể kích hoạt được ngay tại thời điểm nhận
                hàng.
              </li>
              <li>
                Key/Tài khoản bị khóa (Block) hoặc mất bản quyền trong thời gian
                sử dụng cam kết do lỗi từ nhà cung cấp.
              </li>
          ...
          >
            <ul className="list-disc pl-5 space-y-2 font-medium">
              <li>
                Khách hàng chia sẻ tài khoản cho nhiều người, đổi mật khẩu trái
                phép (đối với tài khoản dùng chung).
              </li>
              <li>
                Thiết bị của khách hàng bị lỗi phần cứng, virus không cài được
                phần mềm (đây là lỗi thiết bị, không phải lỗi Key).
              </li>
              <li>
                Khách hàng muốn trả hàng vì lý do cá nhân (đổi ý) sau khi đã
                nhận Key (vì Key đã lộ, không thể thu hồi).
              </li>
            </ul>
          </PolicySection>
          ...
          >
            <div className="space-y-3">
              <div className="flex gap-3">
                ...
                <p>
                  Nhân viên kiểm tra hóa đơn và trạng thái Key trên hệ thống.
                </p>
              </div>
              <div className="flex gap-3">
                <span className="font-bold text-vtv-green">B2.</span>
                <p>
                  Nếu lỗi hợp lệ: Hệ thống thu hồi Key cũ{' '}
                  <span className="text-vtv-green">→</span> Cấp ngay Key mới qua
                  Email/Zalo cho khách hàng.
                </p>
              </div>
            </div>
          </PolicySection>
      ...
      content: (
        <div className="space-y-8 text-gray-300 relative">
          ...
          <div className="relative pl-10 md:pl-12">
            <span className="absolute left-0 top-0 bg-vtv-green text-black font-bold w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center text-sm ring-4 ring-[#1e293b]">
              1
            </span>
            <h4 className="text-lg font-bold text-white mb-2 pt-0.5 md:pt-1">
              Lựa chọn Sản phẩm
            </h4>
            <p className="text-sm md:text-base">
              Truy cập trang chủ, tìm kiếm phần mềm cần mua (Ví dụ: Office 365,
              Windows 10...).
            </p>
          </div>
          ...
          <div className="relative pl-10 md:pl-12">
            ...
            <p className="text-sm md:text-base mb-2">
              Chọn đúng nhu cầu (Ví dụ: "Gói 1 Năm" hoặc "Gói Vĩnh Viễn").
            </p>
          ...
          <div className="relative pl-10 md:pl-12">
            ...
            <p className="text-sm md:text-base">
              Hệ thống tự động kiểm tra kho hàng. Sau khi thanh toán thành công
              qua QR Code, Key sẽ được gửi tự động.
            </p>
          </div>
          ...
          <div className="relative pl-10 md:pl-12">
            ...
            <p className="text-sm md:text-base">
              Kiểm tra Email hoặc mục "Lịch sử đơn hàng" để lấy Key. Nhập Key
              vào phần mềm để kích hoạt.
            </p>
          </div>
        </div>
      ),
