      ...
      >
        ...
        <div className="bg-slate-800/50 rounded-xl p-4 mb-6 border border-slate-700 text-left">
            <div className="flex items-start gap-3">
                ...
                <div>
                    <h3 className="text-white font-bold text-sm">Kiểm tra Email ngay</h3>
                    <p className="text-xs text-gray-400 mt-1">Mã Key/Tài khoản đã được hệ thống gửi tự động đến email của bạn. Vui lòng kiểm tra cả hộp thư Spam.</p>
                </div>
            </div>
        </div>

        <div className="space-y-3">
            <Link to="/" className="block w-full bg-vtv-green text-black font-bold py-3 rounded-lg hover:bg-green-400 transition">
                Tiếp tục mua sắm
            </Link>
